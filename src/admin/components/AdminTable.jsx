...
export default function AdminTable({ columns, data, searchPlaceholder = 'Search…', emptyText = 'No records found' }) {
                ...
                {totalPages > 1 && (
                    <div className="flex items-center justify-between px-6 py-4 border-t border-slate-100 bg-white">
                        ...
                        <div className="flex items-center gap-1.5">
                            <PagBtn disabled={safePage <= 1} onClick={() => setPage(p => Math.max(1, p - 1))}>‹ Prev</PagBtn>
                            ...
                            <PagBtn disabled={safePage >= totalPages} onClick={() => setPage(p => Math.min(totalPages, p + 1))}>Next ›</PagBtn>
                        </div>
                    </div>
                )}
            </div>
